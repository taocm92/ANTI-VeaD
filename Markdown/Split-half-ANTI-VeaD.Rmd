...
outliers_performance = c(106, 120, 137, 140) # Outliers must have been identified previously
outliers_performance_IDtrials = c(107, 122, 134, 137, 138, 140, 141, 159, 170, 171, 179, 182, 222) # Outliers must have been identified previously
```
...
set.seed(1)
antiRT_rels = ldply(
  .data = 1:1e1 # Number of iterations we want to set (for 10,000 iterations set 1:1e4)
